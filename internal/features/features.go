...
var Specs = []Spec{
	...
	{Key: "exec_policy", Stage: StageExperimental, DefaultEnabled: true},
	{Key: "experimental_sandbox_command_assessment", Stage: StageExperimental, DefaultEnabled: false},
	{Key: "enable_experimental_windows_sandbox", Stage: StageExperimental, DefaultEnabled: false},
